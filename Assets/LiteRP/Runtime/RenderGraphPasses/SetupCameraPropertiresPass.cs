...
namespace LiteRP
{
    ...
    {
        private static readonly ProfilingSampler _setupCameraPropertiesProfilingSampler = new ProfilingSampler("Setup Camera Properties");
        ...
        {
            using (var builder = renderGraph.AddRasterRenderPass<SetupCameraPropertiesPassData>("SetupCameraProperties", out var passdata, _setupCameraPropertiesProfilingSampler))
            {
